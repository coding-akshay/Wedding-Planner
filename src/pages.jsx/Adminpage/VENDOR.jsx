...
function Vendor() {
  return (
    ...
    <div className="bg-gray-50 min-h-screen">
      {/* Header Section */}
      <div className="bg-cover bg-center h-96 flex items-center justify-center text-white" style={{ backgroundImage: "url(src/assets/Images/business-5475661_1280.jpg)" }}>
        <div className="bg-black bg-opacity-50 p-6 rounded-md text-center">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Grow your business with WeddingPlanner</h1>
          ...
          <button className="mt-6 px-6 py-3 bg-pink-500 hover:bg-pink-600 text-white font-semibold rounded shadow">Sign Up</button>
        </div>
      </div>
      ...
      <div className="bg-gray-100 py-12">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-6">Showcase your business</h2>
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                Be visible to couples on top search engines with your custom, mobile-friendly WeddingWire Storefront.
              </li>
              <li className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                Reach more engaged couples and receive lead details immediately to your email and phone.
              </li>
              <li className="flex items-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                Track performance and get expert advice to help you make the most of your listing.
              </li>
            </ul>
          </div>
           <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <form>
              ...
              <button className="w-full py-3 bg-pink-600 text-white font-semibold rounded hover:bg-pink-700">Log In</button>
        ...
        <div className="bg-gray-50 py-12">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <img
                src="src/assets/Images/gen_access-menu_en-IN.png"
                alt="Manage Growth"
                className="w-full rounded-lg shadow-md"
              />
            </div>
            <div>
              <h2 className="text-2xl font-semibold mb-6">Manage your business and track your growth</h2>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  Customize your WeddingWire Storefront by adding a business description, photos, service details, and more.
                </li>
                <li className="flex items-start">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  Get notified instantly about new leads and messages by email and phone so you can respond quickly.
                </li>
                <li className="flex items-start">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  Quickly request reviews from couples and monitor your analytics.
                </li>
              </ul>
            </div>
          </div>
