...
import food from '../../assets/Images/spring-roll-6760871_1280.jpg';
import image2 from '../../assets/Images/bake-5160388_1280.jpg';
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        ...
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-bold">VegAndSnaks</h1>
