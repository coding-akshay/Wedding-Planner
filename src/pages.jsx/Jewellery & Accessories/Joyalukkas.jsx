...
import Joyalukkasitem from "../../assets/Images/gold-1369453.jpg";
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        ...
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-bold">Joyalukkas</h1>
          ...
          <div>
            <p className="text-xl font-bold text-green-600">₹20000</p>
      ...
      {/* About Section */}
<div className="bg-white shadow rounded-lg p-6 mb-8">
  <h2 className="text-xl font-bold mb-4">About Joyalukkas</h2>
  <p className="text-gray-700">
    Joyalukkas Bridal store has been established in Hyderabad to cater to
    the intricate bridal jewelry needs of customers. Known for their
    high-quality craftsmanship and unique designs, Joyalukkas offers a
  ...
  <div className="mt-4">
    <h3 className="text-lg font-semibold mb-2">
      Designs Offered by Joyalukkas Bridal Store
    </h3>
    <ul className="list-disc pl-6 text-gray-700">
  ...
  <div className="mt-4">
    ...
    <p className="text-gray-700">
      If you want something special, Joyalukkas provides customization
