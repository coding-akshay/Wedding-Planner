...
import RelianceJewelsitem from "../../assets/Images/gold-1369453.jpg";
  ...
  return (
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        <img
          src={RelianceJewelsitem}
          alt="The Royal Mahal"
          className="rounded-lg w-full h-64 object-cover mb-4"
        />
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-bold">RelianceJewels</h1>
      ...
      {/* About Section */}
<div className="bg-white shadow rounded-lg p-6 mb-8">
  <h2 className="text-xl font-bold mb-4">About RelianceJewels</h2>
  <p className="text-gray-700">
  RelianceJewels Bridal store has been established in Hyderabad to cater to
    the intricate bridal jewelry needs of customers. Known for their
    high-quality craftsmanship and unique designs, RelianceJewels offers a
  ...
  <div className="mt-4">
    <h3 className="text-lg font-semibold mb-2">
      Designs Offered by RelianceJewels Bridal Store
    </h3>
    <ul className="list-disc pl-6 text-gray-700">
  ...
  <div className="mt-4">
    ...
    <p className="text-gray-700">
      If you want something special,RelianceJewels provides customization
