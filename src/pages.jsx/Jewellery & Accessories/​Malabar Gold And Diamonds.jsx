...
import mainImage from "../../assets/Images/gold-1369453.jpg"; // Renamed for clarity
  ...
  return (
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        <img
          src={mainImage}
          alt="MalabarGold And Diamonds"
          className="rounded-lg w-full h-64 object-cover mb-4"
        />
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-bold">MalabarGold And Diamonds</h1>
          ...
          <div>
            <p className="text-xl font-bold text-green-600">₹30,000</p>
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold">Albums ({images.length})</h2>
          <button
      ...
      {/* About Section */}
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        <h2 className="text-xl font-bold mb-4">About MalabarGold And Diamonds</h2>
        <p className="text-gray-700">
          MalabarGold And Diamonds Bridal store has been established in Hyderabad to cater to
          the intricate bridal jewelry needs of customers. Known for their
          high-quality craftsmanship and unique designs, MalabarGold And Diamonds offers a
          stunning range of bridal and wedding accessories inspired by nature
          and traditional Indian aesthetics.
        </p>
        <div className="mt-4">
          <h3 className="text-lg font-semibold mb-2">
            Specialization of MalabarGold And Diamonds
          </h3>
        ...
        <div className="mt-4">
          <h3 className="text-lg font-semibold mb-2">
            Designs Offered by MalabarGold And Diamonds Bridal Store
          </h3>
          <ul className="list-disc pl-6 text-gray-700">
        ...
        <div className="mt-4">
          ...
          <p className="text-gray-700">
            If you want something special, MalabarGold And Diamonds provides customization
        ...
        <div className="mt-4">
          ...
          <ul className="list-none text-gray-700">
            <li className="mb-2">
              <strong>Wedding Planner:</strong> 6 years 3 months
            </li>
            <li className="mb-2">
...
export default MalabarGoldAndDiamonds;
