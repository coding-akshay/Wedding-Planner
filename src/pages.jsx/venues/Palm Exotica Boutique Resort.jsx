    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        ...
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-bold"> PalmExoticaBoutiqueResort </h1>
            <p className="text-gray-600">Hyderabad</p>
            <p className="text-yellow-500 font-semibold mt-1">5.0 ⭐ (No Reviews)</p>
          </div>
          <div>
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="border p-4 rounded-lg">
            ...
            <p>Indoor - 2000 Seats | 5000 Floating</p>
          </div>
          <div className="border p-4 rounded-lg">
            <h3 className="font-semibold">Royal Galaxy Mahal Banquet Hall</h3>
            <p>Indoor - 3000 Seats | 4500 Floating</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-6 mb-8">
        ...
        <ul className="list-disc list-inside">
          <li>Rental Price Per Day: ₹3,500</li>
          <li>Rental Price Per Day: ₹12,000</li>
        </ul>
      </div>
       {/* Amenities*/}
       <div className="bg-white shadow rounded-lg p-6 mb-8">
...
export default PalmExoticaBoutiqueResort
